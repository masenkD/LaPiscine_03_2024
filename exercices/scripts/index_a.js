...
// const tomatoPizzas = pizzas.filter(el => el.baseTomate)
// console.log(tomatoPizzas)

// const tomatoPizzasNames = tomatoPizzas.map((el => el.name))
// console.log(tomatoPizzasNames)
...
const peopleWithCar = people.filter(el => el.vehicle === "car")
const NameOfPeopleWithCar = peopleWithCar.map(el => el.name)

console.log(NameOfPeopleWithCar)