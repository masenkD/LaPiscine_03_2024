...
// BONUS casse-tête
// On clique sur une case mais c'est la case la plus basse disponible dans la même colonne qui change la couleur
...
function onInnerSquareClick(e) {
    if (e.currentTarget.isClicked) {
        return
    }

// Condition ternaire
e.currentTarget.style.backgroundColor = clickIsRed ? "red" : "yellow"
